(() => {
      ...
      if (
        ...
        if (0 === t) r[e ? "scrollLeft" : "scrollTop"] = -d;
          ...
          if (!n.support.smoothScroll)
            return (
              A({ swiper: n, targetPosition: -d, side: e ? "left" : "top" }), !0
            );
    ...
    slideTo: function (e, t, s, i, a) {
      ...
      if (r.cssMode) {
        ...
        if (0 === t) {
          ...
          if (!n.support.smoothScroll)
            return (
              A({ swiper: n, targetPosition: s, side: e ? "left" : "top" }), !0
            );
  ...
  function me(e) {
        ...
        0 !== l.length &&
          l.each((e) => {
            ...
            const o = l.attr("data-background"),
              ...
              p = l.attr("data-sizes"),
              u = l.parent("picture");
            t.loadImage(l[0], c || o, d, p, !1, () => {
              if (null != t && t && (!t || t.params) && !t.destroyed) {
                if (
                  (o
                    ? (l.css("background-image", `url("${o}")`),
                      l.removeAttr("data-background"))
                    : (d && (l.attr("srcset", d), l.removeAttr("data-srcset")),
                      ...
                      c && (l.attr("src", c), l.removeAttr("data-src"))),
    ...
    function o() {
      ...
      if (
        ...
        e.children(`.${s.slideVisibleClass}`).each((e) => {
          r(n ? T(e).attr("data-swiper-slide-index") : T(e).index());
        });
    ...
    function c() {
      ...
      p ? (o(), s.off("scroll", c, h)) : n || ((n = !0), s.on("scroll", c, h));
    }
    i("beforeInit", () => {
  ...
  function be(e) {
    let { swiper: t } = e;
    Object.assign(t, {
      appendSlide: ge.bind(t),
      prependSlide: ve.bind(t),
      addSlide: ye.bind(t),
  ...
  window.addEventListener("load", function (e) {
    Te(),
      document.querySelector(".first__slider") &&
        new ce(".first__slider", {
          modules: [pe, he, fe, Ee, me, be],
          observer: !0,
          observeParents: !0,
          slidesPerView: 1,
          spaceBetween: 0,
      ...
      document.querySelector(".two__slider") &&
        new ce(".two__slider", {
          modules: [pe, he, fe, Ee, me, be],
          observer: !0,
          observeParents: !0,
          ...
          autoHeight: !0,
          speed: 800,
          pagination: { el: ".swiper-pagination-two", clickable: !0 },
          navigation: {
            nextEl: ".swiper-button-next-two",
            prevEl: ".swiper-button-prev-two",
          },
          breakpoints: {
            50: { slidesPerView: 1, spaceBetween: 0, autoHeight: !0 },
      ...
      document.querySelector(".body-slider-look__slider") &&
        new ce(".body-slider-look__slider", {
          modules: [pe, he, fe, Ee, me, be],
          observer: !0,
          observeParents: !0,
          slidesPerView: 3,
          ...
          speed: 800,
          spaceBetween: 20,
          pagination: { el: ".body-slider-look__pagination", clickable: !0 },
          navigation: {
            nextEl: ".body-slider-look__swiper-button-next",
            prevEl: ".body-slider-look__swiper-button-prev",
          },
          breakpoints: {
            320: { slidesPerView: 1, spaceBetween: 0, autoHeight: !0 },
            768: { slidesPerView: 2, spaceBetween: 20 },
  ...
  document.querySelector("._searchClick");
  document.addEventListener("click", function (e) {
    if (e.target.closest("._searchClick")) {
      return (
        document
          .querySelector(".icon-logo__search-form")
          .classList.toggle("_active"),
        0
      );
    }
    if (
      !e.target.closest(".searchClick") &&
      !e.target.closest(".icon-logo__form-input")
    ) {
      document
        .querySelector(".icon-logo__search-form")
        .classList.remove("_active");
    }
    if (e.target.closest(".icon-logo__form-input")) return 0;
  });
  document.querySelector(".many-type-rectangle");
  document.addEventListener("click", function (e) {
    if (e.target.closest(".many-type-rectangle")) {
      let e = document.querySelector(".products__items"),
        t = document.querySelector(".one-type-products");
      e.classList.add("_active-product"),
        t.classList.remove("_active-one-product"),
        console.log("Включить каторки множественные");
      let s = document.querySelectorAll(".one-type-rectangle__item"),
        i = document.querySelectorAll(".many-type-rectangle__item_long");
      s.forEach((e) => {
        e.classList.remove("_active-one-type-rectangle");
      }),
        i.forEach((e) => {
          e.classList.remove("_active-one-type-rectangle");
        }),
        document.querySelectorAll(".many-type-rectangle__item").forEach((e) => {
          e.classList.remove("_no-active-many-rectangle");
        });
    }
    if (e.target.closest(".one-type-rectangle")) {
      let e = document.querySelector(".one-type-products"),
        t = document.querySelector(".products__items");
      e.classList.add("_active-one-product"),
        t.classList.remove("_active-product"),
        console.log("Включить каторки одиночные"),
        t.classList.remove("_active-products-item"),
        document.querySelectorAll(".many-type-rectangle__item").forEach((e) => {
          e.classList.add("_no-active-many-rectangle");
        });
      let s = document.querySelectorAll(".one-type-rectangle__item"),
        i = document.querySelectorAll(".many-type-rectangle__item_long");
      s.forEach((e) => {
        e.classList.add("_active-one-type-rectangle");
      }),
        i.forEach((e) => {
          e.classList.add("_active-one-type-rectangle");
        });
  ...
  let _e = "2";
  document.addEventListener("click", function (e) {
    document.querySelectorAll("parametr-product__none");
    console.log("Проверка последнего значения клика = " + _e);
    let t = document.querySelector("._lastClick");
    t && t.classList.remove("_lastClick");
    if (e.target.closest(".body-bottom-product__item_1") && "1" != _e) {
      document.querySelector("._active-li").classList.remove("_active-li"),
        document.querySelector(".___1").classList.add("_active-product");
      let e = ".___" + _e,
        t = document.querySelector(e);
      console.log(t),
        console.log(e),
        t.classList.add("_lastClick"),
        document
          .querySelector(".body-bottom-product__item_1")
          .classList.add("_active-li"),
        console.log("Переключение"),
        (_e = "1");
    }
    if (e.target.closest(".body-bottom-product__item_2") && "2" != _e) {
      document.querySelector("._active-li").classList.remove("_active-li"),
        document
          .querySelector(".body-bottom-product__item_2")
          .classList.add("_active-li"),
        console.log("Переключение"),
        document.querySelector(".___2").classList.add("_active-product");
      let e = ".___" + _e,
        t = document.querySelector(e);
      console.log(t), console.log(e), t.classList.add("_lastClick"), (_e = "2");
    }
    if (e.target.closest(".body-bottom-product__item_3") && "3" != _e) {
      document.querySelector("._active-li").classList.remove("_active-li"),
        document
          .querySelector(".body-bottom-product__item_3")
          .classList.add("_active-li"),
        console.log("Переключение");
      let e = ".___" + _e,
        t = document.querySelector(e);
      console.log(t), console.log(e), t.classList.add("_lastClick"), (_e = "3");
    }
    if (e.target.closest(".body-bottom-product__item_4") && "4" != _e) {
      console.log("lastTextBlockClick = " + _e),
        document.querySelector("._active-li").classList.remove("_active-li"),
        document
          .querySelector(".body-bottom-product__item_4")
          .classList.add("_active-li"),
        document.querySelector(".___4").classList.add("_active-product"),
        console.log("Переключение");
      let e = ".___" + _e,
        t = document.querySelector(e);
      console.log(t),
    ...
    if (e.target.closest(".body-bottom-product__item_5") && "5" != _e) {
      document.querySelector("._active-li").classList.remove("_active-li"),
        document
          .querySelector(".body-bottom-product__item_5")
          .classList.add("_active-li"),
        console.log("Переключение"),
        document.querySelector(".___5").classList.add("_active-product");
      let e = ".___" + _e,
        t = document.querySelector(e);
      console.log(t), console.log(e), t.classList.add("_lastClick"), (_e = "5");
    }
  }),
    document.addEventListener("click", function (e) {
      if (e.target.closest(".menu__item_service")) {
        console.log("Клик прошёл по услугам"),
          document
            .querySelector(".services-header-logo")
            .classList.add("_activeService"),
          (Le = 1);
      }
      if (e.target.closest(".services-header-logo__img-logo")) {
        console.log("Клик прошёл по стрелке"),
          document
            .querySelector(".services-header-logo")
            .classList.remove("_activeService"),
          (Le = 0);
      }
      if (
        !e.target.closest(".menu__item_service") &&
        !e.target.closest(".services-header-logo") &&
        1 == Le
      ) {
        console.log("Клик прошёл по пустоте"),
          document
            .querySelector(".services-header-logo")
            .classList.remove("_activeService"),
          (Le = 0);
  ...
  (window.FLS = !0),
    ...
    (function () {
      ...
      function l(e, i) {
        e.forEach((e) => {
          !(function (e, i = !1) {
            const a = (e = i ? e.item : e).querySelector(
      ...
      function c(e) {
        ...
        } else "resize" === c && (i.length && l(i), a.length && n(a));
      }
      e.length &&
